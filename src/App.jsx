...
function App() {
  ...
  return (
    <div class="text-[#eae3ae] mx-8 mt-48">
      ...
      <section id="about" class="flex flex-col items-center mb-96">
        <div class="content-card flex flex-col gap-8">
          <div class="pt-4">
          ...
          <div class="flex gap-8 mb-4">
            <a href="https://www.linkedin.com/in/s-m-v-a-lakshmanacharyulu-ponduru-43b8aa24b" class="p-2 bg-[#ffbb006b] rounded">LinkedIn</a>
            <a href="https://github.com/Murari-Lakshman" class="px-4 py-2 bg-[#ffbb006b] rounded">Github</a>
            <a href="https://leetcode.com/u/MxWHMnMB8v/" class="p-2 bg-[#ffbb006b] rounded">Leetcode</a>
          </div>
        </div>
      </section>

      <section id="skills" class="flex flex-col mb-96">
        <div class="content-card">
          ...
          <ul class="flex flex-col gap-4">
            ...
            <li class="content-card"><span>Tools & Methodologies: Git, GitHub, Agile/Scrum, SQL Server, Data Structures, Algorithms</span></li>
            <li class="content-card"><span>Data Science: </span>Data Pipelines, ETL Processes, Data Engineering, BeautifulSoup, PowerBi, Data Visualization</li>
          </ul>
        </div>
      </section>
        ...
        <div>
          ...
          <ul>
            <li>
              ...
              <div>
              <p>CoreCard, Norcross, Georgia | May 2025 to July 2025</p>
              <p>
            ...
            <li>
              ...
              <div>
              <p>Techsophy Solutions Pvt. Ltd., Hyderabad, India | May 2023 to July 2023</p>
              <p>
